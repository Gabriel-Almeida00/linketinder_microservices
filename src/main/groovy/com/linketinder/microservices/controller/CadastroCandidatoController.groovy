...
@WebServlet(name = "CadastroCandidatoController", urlPatterns = "/cadastro/candidato/*")
class CadastroCandidatoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        servletResponse.methodPost(response, () -> {
            ...
            this.cadastroService.cadastrarCandidato(candidato)
        })
    }
}
